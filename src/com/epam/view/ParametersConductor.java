...
public class ParametersConductor {
	...
	public Request prepareAddParams(Request request, ResourceBundle resourseMenu) {
	...
	public Request prepareAddEMailParams(Request request, ResourceBundle resourseMenu) {
		Date date = setDate(resourseMenu);
		if(date == null){
			return request;
		}
	...
	public Request prepareAddSignParams(Request request, ResourceBundle resourseMenu) {
		Date date = setDate(resourseMenu);
		if(date == null){
			return request;
		}
	...
	public Request prepareAddTitleParams(Request request, ResourceBundle resourseMenu) {
		Date date = setDate(resourseMenu);
		if(date == null){
			return request;
		}
	...
	public Request prepareChangeParams(Request request, ResourceBundle resourseMenu) {
		System.out.println(resourseMenu.getString("addMenu"));
		int index = 0;
		try {
			index = scan1.nextInt();
	...
	public Request prepareCloneParams(Request request, ResourceBundle resourseMenu) {
	...
	public Request prepareDeleteParams(Request request, ResourceBundle resourseMenu) {
		System.out.println(resourseMenu.getString("indexMenu"));
		int index = 0;
		try {
			index = scan1.nextInt();
	...
	public Request prepareFindParams(Request request, ResourceBundle resourseMenu) {
	...
	public Request prepareFindEMailParams(Request request, ResourceBundle resourseMenu) {
	...
	public Request prepareFindSignParams(Request request, ResourceBundle resourseMenu) {
	...
	public Request prepareFindTitleParams(Request request, ResourceBundle resourseMenu) {
	...
	public Request prepareFindDateParams(Request request, ResourceBundle resourseMenu) {
	...
	public Request prepareFindNoteParams(Request request, ResourceBundle resourseMenu) {
	...
	public Request prepareFormatParams(Request request, ResourceBundle resourseMenu) {
		System.out.println(resourseMenu.getString("searchNoteMenu"));
		int index = 0;
		try {
			index = scan1.nextInt();
	...
	public Request prepareReplaceParams(Request request, ResourceBundle resourseMenu) {
		Date date = setDate(resourseMenu);
		if(date == null){
			return request;
		}
	...
	private Date setDate(ResourceBundle resourseMenu) {
		Date date = null;
